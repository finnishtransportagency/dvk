...
import { FairwayCard, QueryFairwayCardLatestArgs } from '../../../../graphql/generated';
...
export const handler: AppSyncResolverHandler<QueryFairwayCardLatestArgs, FairwayCard | undefined> = async (
  event: AppSyncResolverEvent<QueryFairwayCardLatestArgs>
