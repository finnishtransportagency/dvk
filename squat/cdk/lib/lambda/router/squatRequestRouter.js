function handler(event) {
  ...
  // TODO: if needed, it might be possible to redirect everything to root (squat) s3 folder
  // but in that case edgelambda for origin request is probably needed
  // as cf functions are viewer request/response only and resulted in some weird cache behaviour
  // with dvk app
