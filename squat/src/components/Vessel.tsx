      ...
      <IonCardContent>
        <IonAccordionGroup>
          ...
          <IonAccordion value="detailed">
            ...
            <IonList slot="content">
              <IonItem>
                <IonLabel position="stacked">{t("homePage.squat.vessel.total-lateral-wind-surface")} (m<sup>2</sup>)</IonLabel>
              ...
              <IonItem>
                <IonLabel position="stacked">{t("homePage.squat.vessel.estimated-deck-cargo")} (m<sup>2</sup>)</IonLabel>
