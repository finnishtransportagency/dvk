...
import { getHarborStyle, getRestrictionStyle, getSelectedRestrictionStyle } from './layerStyles/harborStyles';
...
export function addAPILayers(map: Map) {
  ...
  addFeatureVectorLayer({
    ...
    id: 'restrictionport',
    renderBuffer: 100,
    style: (feature) => (feature.get('hoverStyle') ? getSelectedRestrictionStyle() : getRestrictionStyle()),
    zIndex: 306,
  });
