...
const symbol2Icon = {
  ...
  w: { icon: w, center: true, anchorY: 0 },
  A: { icon: A, center: false, anchorY: 24 },
  B: { icon: B, center: false, anchorY: 24 },
  C: { icon: C, center: false, anchorY: 24 },
  D: { icon: D, center: false, anchorY: 24 },
  ...
  '2': { icon: n2, center: false, anchorY: 24 },
  '3': { icon: n3, center: false, anchorY: 24 },
  '4': { icon: n4, center: false, anchorY: 24 },
  '5': { icon: n5, center: false, anchorY: 24 },
  '6': { icon: n6, center: false, anchorY: 24 },
  '7': { icon: n7, center: false, anchorY: 24 },
  '8': { icon: n8, center: false, anchorY: 24 },
  '9': { icon: n9, center: false, anchorY: 24 },
  '0': { icon: n0, center: false, anchorY: 24 },
  '?': { icon: questionmark, center: true, anchorY: 0 },
};
